...
import com.cyrillo.posicao.infra.config.Sessao;
...
public class HealthCheckService extends HealthImplBase {
    ...
    private static final String ACCEPTED_SERVICE = "com.cyrillo.negociacao.infra.entrypoint.servicogrpc.NegociacaoServerGRPC";
    @Override
